...
<div class="content px-2 py-5 bg-gradient-primary">
	<h4 class="my-3"><b><?= !isset($id) ? "Tạo câu trả lời mới" : "Chỉnh sửa câu trả lời" ?></b></h4>
</div>
				...
				<div class="container-fluid">
					<form action="" id="response-form">
						...
						<div class="form-group">
							<label for="response" class="control-label">Câu trả lời</label>
						...
						<div class="row bg-gradient-primary">
							<div class="col-11 border m-0 px-2 py-1">Từ khóa</div>
							<div class="col-1 border m-0 px-2 py-1">Hoạt động</div>
						</div>
						...
						<div class="text-right">
							<button class="btn btn-primary btn-sm rounded-0" type="button" id="add_kw_item"><i class="far fa-plus-square mb-n2 mr-1"></i>Thêm từ khóa</button>
						</div>
						<div class="clear-fix mt-3"></div>
						<div class="row bg-gradient-primary">
							<div class="col-11 border m-0 px-2 py-1">Gợi ý</div>
							<div class="col-1 border m-0 px-2 py-1">Hoạt động</div>
						</div>
						...
						<div class="text-right">
							<button class="btn btn-primary btn-sm rounded-0" type="button" id="add_suggestion_item"><i class="far fa-plus-square mb-n2 mr-1"></i>Thêm gợi ý</button>
						</div>
					</form>
				</div>
			</div>
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary bg-gradient-primary rounded-0" form="response-form"><i class="fa fa-save"></i> Lưu</button>
				<a class="btn btn-sm btn-light bg-gradient-light border rounded-0" href="./?page=responses"><i class="fa fa-angle-left"></i> Quay lại</a>
			</div>
		</div>
	</div>
</div>
