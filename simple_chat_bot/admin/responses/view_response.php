...
<div class="content px-2 py-5 bg-gradient-primary">
	<h4 class="my-3"><b>Xem câu trả lời</b></h4>
</div>
	...
	<div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			...
			<div class="card-footer py-1 text-center">
				<a class="btn btn-sm btn-primary bg-gradient-primary rounded-0" href="./?page=responses/manage_response&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Chỉnh sửa</a>
