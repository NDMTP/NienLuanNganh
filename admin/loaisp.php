                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <td>" . $row["TENLOAI"] . "</td>";
                                                            ...
                                                            <td>
                                                                <!-- Nút Chỉnh sửa -->
                                                                <form action="loaisp_sua.php" method="get"
                                                        ...
                                                        $totalEmployees = $result->num_rows; // Đếm tổng số loại sản phẩm
                                                        echo "<h5>Tổng số loại sản phẩm: $totalEmployees</h5>"; // Hiển thị tổng số loại sản phẩm
                                                    } else {
