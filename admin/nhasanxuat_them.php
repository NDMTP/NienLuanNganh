              ...
              <div class="col-6 col-md-6 col-lg-6">
                <div class="card">
                  <form method="POST" action="nhasanxuat_crud.php">
                    ...
                    <?php
                    // Query to count existing manufacturers
                    ...
                    // Increment the count and add the prefix "NSX"
                    $maloai = "NSX" . ($pn + 1);
                    ?>
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" value="<?php echo $maloai ?>" name="mansx" class="form-control"
                            id="basic-icon-default-fullname" placeholder="ABC" aria-label="Mã nhà sản xuất"
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                          <input type="text" name="tennsx" class="form-control" id="basic-icon-default-fullname"
                            placeholder="Nhập tên nhà sản xuất" aria-label="Tên nhà sản xuất"
