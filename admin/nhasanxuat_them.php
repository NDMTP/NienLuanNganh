                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" value="<?php echo $maloai ?>" name="ma" class="form-control"
                            id="basic-icon-default-fullname" placeholder="ABC" aria-label="John Doe"
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                          <input type="text" name="ten" class="form-control" id="basic-icon-default-fullname"
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                          <input type="text" name="diachi" class="form-control" id="basic-icon-default-fullname"
                            aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                        </div>
                      </div>
