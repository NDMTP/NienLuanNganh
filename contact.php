      ...
      <div class="container-fluid">
        <div class="row">
          <div class="contact-info col-lg-6 pb-3">
            <p>Nếu có thắc mắc gì về sản phẩm, bạn có thể liên hệ với chúng tôi theo hình thức dưới đây</p>
            <div class="page-content d-flex flex-wrap">
              <div class="col-lg-6 col-sm-12">
                <div class="content-box text-dark pe-4 mb-5">
                  ...
                  <div class="contact-address pt-3">
                    <p>123 Khu 2 Đại học Cần Thơ, quận Ninh Kiều, Thành Phố Cần Thơ</p>
                  </div>
                  <div class="contact-number">
                    <p>
                      <a href="#">+84 939 826 024</a>
                    </p>
                    <p>
                      <a href="#">+84 939 123 456</a>
                    </p>
                  </div>
              ...
              <div class="col-lg-6 col-sm-12">
                <div class="content-box">
                  ...
                  <div class="contact-address pt-3">
                    <p>123 Khu 3 Đại học Cần Thơ, quận Ninh Kiều, Thành Phố Cần Thơ</p>
                  </div>
                  <div class="contact-number">
                    <p>
          ...
          <div class="inquiry-item col-lg-6">
            <div class="bg-light p-5 rounded-5">
              <h2 class="display-7 text-dark">Liên lạc</h2>
              <p>Vui lòng nhập thông tin dưới đây để liên hệ với chúng tôi</p>
              <form id="form" class="form-group flex-wrap">
                <div class="form-input col-lg-12 d-flex mb-3">
                  <input type="text" name="email" placeholder="Vui lòng nhập họ tên của bạn ở đây" class="form-control ps-3 me-3">
                  <input type="text" name="email" placeholder="Vui lòng nhập email của bạn ở đây" class="form-control ps-3">
                </div>
                <div class="col-lg-12 mb-3">
                  <input type="text" name="email" placeholder="Số điện thoại" class="form-control ps-3">
                </div>
                <div class="col-lg-12 mb-3">
                  <input type="text" name="email" placeholder="Vui lòng nhập địa chỉ của bạn ở đây" class="form-control ps-3">
                </div>
                <div class="col-lg-12 mb-3">
                  <textarea placeholder="Gửi tin nhắn cho chúng tôi ở đây" class="form-control ps-3" style="height:150px;"></textarea>
                </div>
              </form>
              <div class="d-grid">
                <button class="btn btn-primary btn-lg text-uppercase btn-rounded-none">Gửi biểu mẫu</button>
              </div>
            </div>
          </div>
        </div>
