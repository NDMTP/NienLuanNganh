...
<body>
    ...
    <section class="py-5 mb-5" style="background: url(images/background-pattern.jpg); object-fit: cover;">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                <h1 class="page-title pb-2">Tài khoản</h1>
                <nav class="breadcrumb fs-6">
                    <a class="breadcrumb-item nav-link" href="index.php">Home</a>
                    <a class="breadcrumb-item nav-link" href="#">Tài khoản</a>
        ...
        <div class="container-sm">
            <div class="row justify-content-center">
                <div class="col-lg-2 p-5 ">
                    <div class="wrapper" style="margin-top: 50px; margin-bottom: 70px;">
                        <div class="card-switch">
                            <label class="switch">
                                ...
                                <input type="text" id="fid-name" name="hoten" value="<?php echo $_SESSION["hoten"] ?>"
                                    class="txt-input">
                            </p>
                            <p class="form-row">
                            ...
                            <p class="form-row">
                                ...
                                <input type="text" id="fid-name" name="diachi" value="<?php echo $_SESSION["diachi"] ?>"
                                    class="txt-input">
                            </p>
                            <button class="flip-card__btn" type="submit" name="uduser">Lưu 
                                </button>
                            </form>
                            </label>
                        ...
                        <div class="flip-card__back">
                            ...
                            <form class="flip-card__form" action="dangky.php" method="post">
                                <input class="flip-card__input" name="email" placeholder="Email" type="email">
                                <input class="flip-card__input" name="password" placeholder="Mật khẩu" type="password">
                                <input class="flip-card__input" name="password" placeholder="Nhập lại mật khẩu"
                                    type="password">
                                <input class="flip-card__input" name="hoten" placeholder="Họ tên" type="text">
                                <input class="flip-card__input" name="diachi" placeholder="Địa chỉ" type="text">
                                <input class="flip-card__input" name="sdt" placeholder="Số điện thoại" type="text">
                                <button class="flip-card__btn" type="submit" name="dksthi">Đăng ký</button>
                            </form>
                        </div>
                    </div>
                    </label>
    ...
    <footer class="py-5" style="margin-top: 220px;">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <p>Đăng ký nhận bản tin của chúng tôi để nhận thông tin cập nhật về các ưu đãi lớn của chúng
                            tôi.</p>
                        <form class="d-flex mt-3 gap-0" role="newsletter">
                            <input class="form-control rounded-start rounded-0 bg-light" type="email"
                                placeholder="Email của bạn" aria-label="Email Address">
