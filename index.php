        ...
        <div class="order-md-last">
          ...
          <ul class="list-group mb-3">
            ...
            <?php
                                        ...
                                        ?>
              <div>
                <h6 class="my-0"><a href="#" class="product-name"><?php echo $row['TENSP']?></a></h6>
                <small class="text-body-secondary"><?php echo $row['MOTA']?></small>
              </div>
              <span class="text-body-secondary"><?php echo number_format($row['DONGIABANSP']) ?></span>
            </li>
            <div class="qty">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Đặt hàng ngay</a>
                        </div>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <a href="sanpham.php" class="d-flex align-items-center nav-link">Xem chi tiết <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
              ...
              <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a href="#" class="nav-link text-uppercase fs-6 active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all">Tất cả</a>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-fruits-tab" data-bs-toggle="tab" data-bs-target="#nav-fruits">Rau củ</a>
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <h3>Chuối</h3>
                        <span class="qty">1 Nải<i></i></span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          ...
                          <a href="#" class="nav-link">Thêm vào giỏ hàng <iconify-icon icon="uil:shopping-cart"></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <h3>Bánh Quy</h3>
                        <span class="qty">1 Hộp</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <h3>Chuối</h3>
                        <span class="qty">1 Nải</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                        <span class="price">18.000đ</span>
                        <div class="d-flex align-items-center justify-content-between">
                          <div class="input-group product-qty">
                              <span class="input-group-btn">
