      ...
      <div class="container-fluid">
        <div class="d-flex justify-content-between">
          ...
          <nav class="breadcrumb fs-6">
            ...
            <a class="breadcrumb-item nav-link" href="sanpham.html">Sản phẩm</a>
                ...
                <div class="widget-search-bar">
                  <form role="search" method="get" class="d-flex position-relative">
                    <form class="d-flex mt-3 gap-0" action="index.html">
                      <input class="form-control form-control-lg rounded-2 bg-light" type="email" placeholder="Bạn đang tìm gì" aria-label="Search here">
