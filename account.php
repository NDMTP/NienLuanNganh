                  ...
                  <label class="switch">
                     ...
                     <div class="flip-card__inner">
                        <div class="flip-card__front">
                           ...
                           <form class="flip-card__form" method="post" action="dangnhap.php">
                              <input class="flip-card__input" id="email" name="email" placeholder="Email" type="email">
                              <input class="flip-card__input" id="matkhau" name="password" placeholder="Mật khẩu" type="password">
                              <button class="flip-card__btn" type="submit" name="dnsthi">Đăng nhập</button>
                           </form>
                        </div>
                        <div class="flip-card__back">
                           ...
                           <form class="flip-card__form" action="dangky.php" method="post">
                             ...
                             <input class="flip-card__input" name="password" placeholder="Nhập lại mật khẩu" type="password">
